...
using _1226.Models.Infrastructures;
...
namespace _1226.Models.Services.Services
{
    public class MemberService
    {
        private readonly IMermberRepository repository;
        public MemberService(IMermberRepository repo)
        {
